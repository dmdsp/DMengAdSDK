...
#import <DMengAdSDK/DMengRewardedVideoManager.h>
#import <DMengSDKAdapter/DMengSDKAdapter.h>


static NSString *cellWithIdentifier = @"cellWithIdentifier";

@interface RewardVideoAdapterViewController ()<UITableViewDelegate,UITableViewDataSource,DMengRewardedVideoManagerDelegate>
@property (nonatomic, strong) UITableView *listTable;
@property (nonatomic, copy) NSArray *titleArr;
@property (nonatomic, strong) DMengRewardedVideoAdapter * rewardVideoAd;
...
//        model.userId = @"123";
//        model.rewardTime = 8;
         [[DMengRewardedVideoManager new] loadRewardedVideoAdTemplateAdWithSlotID:@"118171711352679" withRewarVideoModel:nil completion:^(DMengRewardedVideoAdapter * _Nonnull rewardedVideoAdapter) {
...
//        model.userId = @"321";
//        model.rewardTime = 20;
        [[DMengRewardedVideoManager new] loadRewardedVideoAdTemplateAdWithSlotID:@"118171711352643" withRewarVideoModel:nil completion:^(DMengRewardedVideoAdapter * _Nonnull rewardedVideoAdapter) {
            rewardedVideoAdapter.delegate = self;
            self.rewardVideoAd = rewardedVideoAdapter;
       }];
    }
...
- (void)rewardVideoAdDidClick:(nonnull DMengRewardedVideoAdapter *)rewardVideoAd {
...
- (void)rewardVideoAdDidLoad:(nonnull DMengRewardedVideoAdapter *)rewardVideoAd {
...
- (void)rewardVideoAdDidRender:(nonnull DMengRewardedVideoAdapter *)rewardVideoAd {
...
- (void)rewardVideoAdDidShow:(nonnull DMengRewardedVideoAdapter *)rewardVideoAd {
